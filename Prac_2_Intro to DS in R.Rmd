...
author: Centre for Research into Ecological and Environmental Modelling <br> **University
  of St Andrews**
date: Exercise 2. Line transect estimation using R <br>September 2020
output:
...
In this exercise, we use `R` (R Core Team 2018) and the `Distance` package (Miller 2020, Miller *et al.* 2019) to fit different detection function models to the duck nest data (introduced in Exercise 1) and estimate duck nest density and abundance.
...
Miller DL (2020) Distance: Distance Sampling Detection Function and Abundance Estimation. R package version 1.0.1. https://CRAN.R-project.org/package=Distance
